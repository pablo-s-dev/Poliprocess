...
function Product(props: {title: string, image: string, href: string, cor: string}){
    ...
    return (
            ...
            <div className="text-[#101010] flex sm:flex-row sm:justify-center items-center sm:h-[80vmin] w-[90vw]  bg-gray-50 shadow-md mb-[2vmin] p-[2vmin] flex-col h-[120vmin]">
                
                <div className=" flex flex-col justify-center items-center pb-[10vmin]  pt-[10vmin] flex-grow sm:h-[100%] relative">
                    <img src={props.image} alt="product" style={{width: 'min-content', height: '90%'}} className="shadow-lg"/>

                    <span className="pt-[2vmin] opacity-60 text-center">Imagem meramente ilustrativa</span>
                </div>
                {/* <Vline/> */}
                
                <div className="flex flex-col justify-center items-center  flex-grow  sm:max-h-[90%] max-w-[90vw]  sm:max-w-[50vw] relative">
                    <div id="just-a-border" className="border border-grey rounded-lg flex flex-col justify-around items-center px-[5vmin] h-[75vmin] w-[60%] min-w-max  ">
